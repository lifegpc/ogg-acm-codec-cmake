...
{
	return ::DefDriverProc(DWORD_PTR(this),handle(),uMsg,lParam1,lParam2);
}
// 未ハンドル処理フィルタ
...
/*****************************************************************
	メッセージディスパッチャ
*****************************************************************/
LRESULT CALLBACK CDriver::DriverProc(DWORD_PTR dwId, HDRVR hdrvr, UINT uMsg, LPARAM lParam1, LPARAM lParam2)
{
	LRESULT lRes = 0L;
