...
public:
	...
	LRESULT send(UINT uMsg, WPARAM wParam, LPARAM lParam, UINT fuFlags, UINT uTimeout, PDWORD_PTR lpdwResult) { LRESULT l=::SendMessageTimeout(handle(),uMsg,wParam,lParam,fuFlags,uTimeout,lpdwResult); CHECKRESULT_API(l); return l; }
	...
	LRESULT send(UINT uMsg, WPARAM wParam, LPARAM lParam, UINT fuFlags, UINT uTimeout, PDWORD_PTR lpdwResult) const { LRESULT l=::SendMessageTimeout(handle(),uMsg,wParam,lParam,fuFlags,uTimeout,lpdwResult); CHECKRESULT_API(l); return l; }
	// 親(オーナー)ウィンドウの取得/設定
