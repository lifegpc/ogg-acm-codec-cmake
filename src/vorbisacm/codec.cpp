...
extern "C" LRESULT WINAPI DriverProc(DWORD_PTR dwId, HDRVR hdrvr, UINT uMsg, LPARAM lParam1, LPARAM lParam2)
{
...
/*****************************************************************
	ディスパッチャ
*****************************************************************/
LRESULT CacmDriverOggVorbis::DriverProc(DWORD_PTR dwId, HDRVR hdrvr, UINT uMsg, LPARAM lParam1, LPARAM lParam2)
{
#ifdef _DEBUG
	if(uMsg==DRV_OPEN) {
